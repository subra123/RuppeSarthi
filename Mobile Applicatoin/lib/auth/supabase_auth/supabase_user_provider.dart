...
class RuppeSarthiSupabaseUser extends BaseAuthUser {
  RuppeSarthiSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> ruppeSarthiSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = RuppeSarthiSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
